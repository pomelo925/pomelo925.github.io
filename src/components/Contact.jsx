...
const socialLinks = [
  {
    href: 'https://www.github.com/pomelo925',
  ...
  return (
    ...
    >
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
          ...
          <div className="flex items-center gap-2 mt-auto">
            {socialLinks.map(({ href, icon}, key) => (
              <a 
                ...
                href={href}
                target="_blank"
                className="w-12 h-12 gtid place-items-center ring-inset 
                  ing-2 ring-zinc-50/5 rounded-lg hover:bg-rose-400 hover:text-zinc-950
                  active:bg-zinc-50/80 transition-[background-color, color] reveal-up"
              >
                {icon}
              </a>
            ))}
        ...
        <form
          action="https://getform.io/f/ajjmdwva"
          method="POST"
          ...
          <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
            ...
            <div className="mb-4">
              ...
              <input
                ...
                autoComplete="email"
                required
                placeholder="yoseph.huang@gmail.com"
                className="text-field"
              >
              </input>
            </div>
